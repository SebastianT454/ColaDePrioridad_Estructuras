...
namespace EstructurasDinamicas_ColasDePrioridad
{
    public static class Visualizacion_ColasDePrioridad
    {
        ...
        {
            string filePath = @"C:\Users\Sebastian\source\repos\EstructurasDinamicas-ColasDePrioridad\EstructurasDinamicas-ColasDePrioridad\solicitudes.txt"; // Ruta al archivo con las solicitudes
